    ...
    return (
        <>
            ...
            <div className="relative flex items-center justify-center min-h-screen px-4 py-12 overflow-hidden bg-black">
                ...
                <div className="bg-blue-100 rounded-full animate-random-move-1 w-96 h-96 blur-3xl opacity-20" style={{ top: "10%", left: "5%" }}></div>
                <div className="bg-blue-100 rounded-full animate-random-move-2 w-80 h-80 blur-2xl opacity-30" style={{ bottom: "15%", right: "10%" }}></div>
                <div className="w-64 h-64 bg-blue-100 rounded-full animate-random-move-3 blur-xl opacity-10" style={{ top: "5%", right: "20%" }}></div>
                <div className="bg-blue-100 rounded-full animate-random-move-1 w-72 h-72 blur-2xl opacity-15" style={{ bottom: "10%", left: "15%" }}></div>
                <div className="bg-blue-100 rounded-full opacity-25 animate-random-move-2 w-60 h-60 blur-xl" style={{ top: "20%", left: "60%" }}></div>
                ...
                <div className="relative flex flex-col w-full max-w-6xl gap-4 p-8 border border-b md:gap-12 bg-white/10 backdrop-blur-3xl rounded-3xl md:p-12 md:flex-row backdrop-saturate-300 border-white/20">
                        ...
                        <div className="flex flex-col justify-between h-full px-4 py-6 md:px-6 md:py-8 bg-white/10 border-white/10 rounded-4xl">
                            <div>
                                ...
                                <ul className="space-y-2 text-white/90">
                                    <li>Email: <a href="mailto:support@proptrack.com" className="text-blue-400">support@proptrack.com</a></li>
                    ...
                    <div className="w-full md:w-1/2">
                        <h2 className="mb-6 text-2xl font-semibold text-center text-white">Send Us a Message</h2>
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <select
                                ...
                                required
                            >
                                <option value="" disabled hidden>Subject Options</option>
                            ...
                            <div className="w-full text-right">
                                <Button variant="primary" size="lg" type="submit" className="w-full h-10 mt-4 rounded-lg">
                                    Deliver
                                </Button>
                            </div>
                        </form>
